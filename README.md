...
Software Engineering · UPAEP · Puebla, México · 2026  

I build full-stack applications and learn fast. Every project here started as a problem I didn't know how to solve yet.
...
**GXIBA Satellite Dashboard** — Real-time telemetry platform for a university satellite mission `React` `Supabase` `WebSockets`

**NutriiApp** — Personalized meal planning with dynamic generation and progress tracking `React` `Supabase`

**Car Dealership Platform** — Full design-to-production management system `React` `Figma` `Supabase`

**GYOLAP** — Medical appointment system for a gynecology clinic `PHP` `MySQL`
